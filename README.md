...
[![Build Status](https://img.shields.io/github/actions/workflow/status/chiraitori/paperand/build.yml?branch=main&label=Build%20Release)](https://github.com/chiraitori/paperand/actions/workflows/build.yml)
