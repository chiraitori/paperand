...
[![Build Release](https://img.shields.io/github/actions/workflow/status/chiraitori/paperand/build.yml?branch=v0.0.5-rc&label=Build)](https://github.com/chiraitori/paperand/actions/workflows/build.yml)
